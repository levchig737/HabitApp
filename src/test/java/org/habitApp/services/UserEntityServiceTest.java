...
//    @BeforeEach
//    void setUp() {
//        adminUser = new UserEntity(UUID.randomUUID(), "admin@example.com", "password", "Admin User", true);
//        regularUser = new UserEntity(UUID.randomUUID(), "user@example.com", "password", "Regular User", false);
//    }
//
//    @Test
...
//
//        verify(userRepository, times(1)).registerUser(any(UserEntity.class));
//    }
//
//    @Test
...
//
//        when(userRepository.getUserByEmail(email)).thenReturn(new UserEntity(UUID.randomUUID(), email, password, name, false));
//
...
//
//        UserEntity user = userService.getUser(regularUser.getEmail(), adminUser);
//
//        assertNotNull(user);
...
//
//        List<UserEntity> users = userService.getAllUsers(adminUser);
//
//        assertNotNull(users);
...
//        when(userRepository.getUserByEmail(email)).thenReturn(regularUser);
//
//        UserEntity updatedUser = userService.updateUserProfile(email, newName, newPassword, isAdmin, adminUser);
//

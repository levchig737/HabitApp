...
//    @BeforeEach
//    void setUp() {
//        user = new UserEntity(UUID.randomUUID(), "user", "password", "user", true);
//        habit = new HabitEntity(UUID.randomUUID(), "Exercise", "Daily exercise", "day", LocalDate.now(), user.getId());
//        period = Period.DAY;
//    }
//
//    @Test
...
//
//        verify(habitRepository, times(1)).updateHabit(eq(habitId), any(HabitEntity.class));
//    }
//
//    @Test
...
//        UserEntity otherUser = new UserEntity(UUID.randomUUID(), "other@example.com", "Other User", "test", false);
//        when(habitRepository.getHabitById(habit.getId())).thenReturn(habit);
//
...
//
//        List<HabitEntity> habits = habitService.getAllHabits(user);
//
...
//
//        List<HabitEntity> habits = habitService.getAllHabitsAdmin(user);
//
//        assertNotNull(habits);
//        assertEquals(1, habits.size());
//    }
...
//        UserEntity nonAdminUser = new UserEntity(UUID.randomUUID(), "nonadmin@example.com", "Non Admin", "test",false);
//
